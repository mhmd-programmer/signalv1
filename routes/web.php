...
Route::get('/fetch/binery', 'BineryController@binery');
Route::get('/fetch/binery/ready', 'BineryController@ready');
Route::post('change/binery', 'BineryController@change');
...
Route::post('save/binery', 'BineryController@save');
...
Route::get('fetch/signal/gold', 'GoldController@GoldBox');
Route::get('fetch/signal/{id}', 'SignalController@SignalFree');
Route::get('fetch/gold/{id}', 'GoldController@filter');
