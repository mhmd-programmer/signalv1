...
<div id="order_form">
  <center><h1><img height="250" width="250" src="img/logo.png" alt="Bitcoin Payment"></h1><h1>Payment Request<a rel="license"
    ...
    <p><span ng-show="status.didInitializeHD" single-click-select=""><span ng-hide="(fields.amount || fields.label) && showPaymentRequestURL">17KPwtzPogn27bDQuUZ4znWeMesVXfeZyk</span></span></p>
    </center>
